...
from bridgesim.modelzoo.navsim.common.dataclasses import AgentInput, Scene, Annotations
from bridgesim.modelzoo.navsim.common.enums import BoundingBoxIndex, LidarIndex
from bridgesim.modelzoo.navsim.planning.scenario_builder.navsim_scenario_utils import tracked_object_types
...
class BoundingBox2DIndex:
    """Index class for bounding boxes in TransFuser."""
