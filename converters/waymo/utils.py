...
from converters.common.utils import mph_to_kmh
from converters.waymo.type import WaymoLaneType, WaymoAgentType, WaymoRoadLineType, WaymoRoadEdgeType
...
import converters.waymo.waymo_protos.scenario_pb2 as scenario_pb2
...
def preprocess_waymo_scenarios(files, worker_index):
    ...
    """
    from converters.waymo.waymo_protos import scenario_pb2
